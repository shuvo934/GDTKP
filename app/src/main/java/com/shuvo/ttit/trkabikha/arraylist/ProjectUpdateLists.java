...
public class ProjectUpdateLists {
    ...
    public String getSanctionType_id() {
        return sanctionType_id;
    }

    public void setSanctionType_id(String sanctionType_id) {
        this.sanctionType_id = sanctionType_id;
    }

    public String getPscSanctionCatId() {
        return pscSanctionCatId;
    }

    public void setPscSanctionCatId(String pscSanctionCatId) {
        this.pscSanctionCatId = pscSanctionCatId;
    }

    public String getPcmCategoryId() {
        return pcmCategoryId;
    }
